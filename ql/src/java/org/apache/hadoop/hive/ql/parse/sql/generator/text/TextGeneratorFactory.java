...
public class TextGeneratorFactory {
  ...
  static {
    ...
    genMap.put(PantheraParser_PLSQLParser.TABLEVIEW_NAME, new NothingTextGenerator());
    ...
    genMap.put(PantheraParser_PLSQLParser.ANY_ELEMENT, new AnyElementTextGenerator());
    ...
    genMap.put(PantheraParser_PLSQLParser.NATIONAL_CHAR_STRING_LIT, new NaiveTextGenerator());
    genMap.put(PantheraParser_PLSQLParser.CHAR_STRING_PERL, new NaiveTextGenerator());
    genMap.put(PantheraParser_PLSQLParser.CHAR_STRING, new NaiveTextGenerator());
    ...
    genMap.put(PantheraParser_PLSQLParser.SQL92_RESERVED_AND, new EasyBiOpTextGenerator());
    ...
    genMap.put(PantheraParser_PLSQLParser.FULL_VK, new NaiveTextGenerator());
    genMap.put(PantheraParser_PLSQLParser.LEFT_VK, new NaiveTextGenerator());
    genMap.put(PantheraParser_PLSQLParser.RIGHT_VK, new NaiveTextGenerator());
    ...
    genMap.put(PantheraParser_PLSQLParser.MODEL_EXPRESSION, new NaiveTextGenerator());//?
    ...
    genMap.put(PantheraParser_PLSQLParser.SQL92_RESERVED_DATE, new NaiveTextGenerator());
