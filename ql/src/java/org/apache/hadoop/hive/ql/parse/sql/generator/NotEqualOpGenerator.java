...
public class NotEqualOpGenerator extends BaseHiveASTGenerator {
  ...
  public boolean generate(ASTNode hiveRoot, SqlASTNode sqlRoot, ASTNode currentHiveNode,
    ...
    return super.baseProcess(HiveParser.NOTEQUAL, "!=", hiveRoot, sqlRoot, currentHiveNode, currentSqlNode, context);
  }
