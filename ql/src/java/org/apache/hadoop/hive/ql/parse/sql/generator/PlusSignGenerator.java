...
public class PlusSignGenerator extends BaseHiveASTGenerator {
  ...
  public boolean generate(ASTNode hiveRoot, SqlASTNode sqlRoot, ASTNode currentHiveNode,
    ...
    return super.baseProcess(HiveParser.PLUS, "+", hiveRoot, sqlRoot, currentHiveNode, currentSqlNode, context);
  }
