 ...
 * AsteriskTextGenerator.
 *
 */
public class AsteriskTextGenerator extends BaseTextGenerator {

  @Override
  protected String textGenerate(CommonTree root, TranslateContext context) throws Exception {
    if (root.getChildCount() == 2) {
      //asterisk means multiplier
      ...
      if (root.getChildCount() != 0 ) {
        throw new SqlParseException("Asterisk parameter error!");
      }
      return "*";
    }
  }
