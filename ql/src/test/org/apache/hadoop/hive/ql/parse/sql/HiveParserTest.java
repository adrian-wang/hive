...
public class HiveParserTest {
  ...
  public static void main(String[] args) throws Exception {
    String command = "select ngrams(sentences(lower(contents)), 5, 100, 1000).estfrequency from kafka";
  ...
  static String toTypeString(Tree tree) {
  ...
  static void toTypeStringBuilder(StringBuilder sb, Tree tree) {
